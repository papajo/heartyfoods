...
<head>
    ...
    <meta name="description" content="Heartyfoods is a premium food delivery service with the mission to bring affordable and healty meals to as many people as possible">
    <title>Hearty Foods</title>
...
<body>
   <header>
      <nav>
          <div class="row">
              <img class="logo" src="resources/img/logo-white.png" alt="heartyfoods logo">
              <img class="logo-black" src="resources/img/logo.png" alt="heartyfoods logo">
   ...
   <section class="section-features js-section-features" id="features">
       <div class="row">
            ...
            <p class="long-copy">
                Hello, we’re Heartyfoods, your new premium food delivery service. 
   ...
   <section class="section-steps" id="works">
       ...
       <div class="row">
           <div class="col span-1-of-2 steps-box">
               <img src="resources/img/app-iPhone.png" class="app-screen js-wp-2" alt="Heartyfoods app on iPhone">
           </div>
           <div class="col span-1-of-2 steps-box">
   ...
   <section class="section-cities" id="cities">
       <div class="row">
           <h2>We are currently located in these cities</h2>
       </div>
           ...
           <div class="col span-1-of-4 box">
              ...
              <div class="city-feature">
               ...
               <div class="city-feature">
                   ...
                   <a href="http://twitter.com/heartyfoods_lx">@heartyfoods_lx</a>
               </div>
           </div>
           <div class="col span-1-of-4 box">
              ...
              <div class="city-feature">
               ...
               <div class="city-feature">
                   <i class="ion-social-twitter icon-small"></i>
                   <a href="http://twitter.com/heartyfoods_sf">@heartyfoods_sf</a>
               </div>
           </div>
           <div class="col span-1-of-4 box">
              ...
              <div class="city-feature">
               ...
               <div class="city-feature">
                   <i class="ion-social-twitter icon-small"></i>
                   <a href="http://twitter.com/heartyfoods_berlin">@heartyfoods_berlin</a>
               </div>
           </div>
           <div class="col span-1-of-4 box">
              ...
              <div class="city-feature">
               ...
               <div class="city-feature">
                   <i class="ion-social-twitter icon-small"></i>
                   <a href="http://twitter.com/heartyfoods_london">@heartyfoods_london</a>
               </div>
           </div>
       </div>
   </section>
   <section class="section-testimonials">
       ...
       <div class="col span-1-of-3">
           <blockquote>
               Heartyfoods is just awesome! I just launched a startup which leaves me with no time for cooking, so Heartyfoods is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
            <cite><img src="resources/img/customer-1.jpg" alt="Alberto Duncan">Alberto Duncan</cite>
           </blockquote>
       </div>
       <div class="col span-1-of-3">
           <blockquote>
               Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Heartyfoods. Me and my family are so in love!
            <cite><img src="resources/img/customer-2.jpg" alt="Joana Silva">Joana Silva</cite>
           </blockquote>
       </div>
       <div class="col span-1-of-3">
           <blockquote>
               I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Heartyfoods. Best food delivery service in the Bay Area. Keep up the great work!
       ...
       <div class="row">
           <div class="col span-1-of-3">
               <div class="plan-box js-wp-4">
                   ...
                   <div>
                       <a href="#" class="btn btn-plus">Sign up now!</a>
                   </div>
               </div>
           </div>
           <div class="col span-1-of-3">
               ...
               <div class="plan-box">
                   ...
                   <div>
                       <ul>
                           ...
                           <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 8am to 12 pm</li>
   ...
   <div class="map-box">
    ...
    <footer>
        ...
        <div class="row">
            <p>Copyright &copy; 2016 Heartyfoods Inc. All rights reserved.</p>
        </div>
    </footer>
